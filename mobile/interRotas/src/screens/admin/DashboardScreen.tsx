...
const Rotas=[{ id: '1', nome: 'Linha 101 - Centro x Industrial', status: 'No Prazo', onibus: 'ABC-1234', lat: -23.55052, lng: -46.633308 },
  { id: '2', nome: 'Linha 202 - Interbairros Norte', status: 'Atrasado', onibus: 'XYZ-5678', lat: -23.55552, lng: -46.639308 },
  { id: '3', nome: 'Linha 305 - Distrito Comercial', status: 'No Prazo', onibus: 'MNO-9012', lat: -23.54852, lng: -46.628308 },
];
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#1E293B', // Azul escuro corporativo
  },
  searchContainer: {
    paddingTop: 50,
  ...
  mapContainer: {
    height: Dimensions.get('window').height * 0.35, // O mapa ocupa 35% da tela
    width: '100%',
  },
  map: {
  ...
  listContainer: {
    flex: 1, // Ocupa o restante da tela abaixo do mapa
    padding: 16,
  },
  listTitle: {
    fontSize: 16,
